...
if val == true
    ...
    col_header={'problem_type','pressure_unit', 'pressure_val', 'temp_unit', 'temp_val', 'reactant_amount_unit','reactant_temp_unit','fuel_name_1','fuel_amoun_1','fuel_temp_1','fuel_name_2','fuel_amount_2','fuel_temp_2', 'oxid_name', 'oxid_amount', 'oxid_temp', 'output'};     %Row cell array (for column labels)
